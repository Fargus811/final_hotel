...
public class ClientNotificationSenderImpl implements ClientNotificationSender {
    ...
    private static final String MESSAGE_FILENAME = "../config_mail/notification_message";
    ...
    public  void registerMailNotification(String clientEmail, String clientFirstName, String link) throws CommandException {
    ...
    public void createOrderNotification(String clientEmail) throws CommandException {
        ResourceBundle bundle = ResourceBundle.getBundle(MESSAGE_FILENAME);
...
//
//    public void declineOrderNotification(Booking booking) {
//        ResourceBundle bundle = ResourceBundle.getBundle(MESSAGE_FILENAME);
...
//    }
//
//    public void expiredOrderNotification(Booking expiredBooking) {
//        ResourceBundle bundle = ResourceBundle.getBundle(MESSAGE_FILENAME);
