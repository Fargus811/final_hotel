...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/resources/css/profileSettings.css" type="text/css">
    ...
    <nav aria-label="breadcrumb" class="main-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a
                    href="${pageContext.servletContext.contextPath}/controller?command=show_my_profile">Main Profile
                Page</a></li>
                    ...
                    <div class="tab-pane" id="billing">
                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <button class="btn btn-info" type="button">Add Payment</button>
                            </div>
                        </form>
                    </div>
                </div>
